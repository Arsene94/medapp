...
import { Activity, Apple, Lock, Mail, User } from "lucide-react";
              ...
              <div className="mx-auto w-full max-w-md">
                ...
                <div className="mb-10">
                  ...
                  <p className="text-sm text-[#515f74]">
                    Completează datele tale pentru a începe.
                  </p>
                </div>
                ...
                >
                  ...
                  <div className="flex items-start gap-3 py-1">
                    <input
                      className="mt-1 h-5 w-5 rounded border-[#bdc9c8] bg-[#d5e3fd] text-[#006565] focus:ring-[#006565]/20"
                      id="terms"
                      required
                      type="checkbox"
                    />
                    <label
                      className="text-sm leading-tight text-[#3e4949]"
                      htmlFor="terms"
                    >
                      Accept{" "}
                      <a
